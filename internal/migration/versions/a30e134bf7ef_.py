...
Revision ID: a30e134bf7ef
Revises: b896255a736a
Create Date: 2025-06-09 22:22:38.684390
...
revision = 'a30e134bf7ef'
down_revision = 'b896255a736a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('mine_type', sa.String(length=255), server_default=sa.text("''::character varying"), nullable=False),
