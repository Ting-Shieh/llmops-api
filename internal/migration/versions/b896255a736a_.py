...
Revision ID: b896255a736a
Revises: 1f4684722e7a
Create Date: 2025-05-12 22:49:02.100476
...
revision = 'b896255a736a'
down_revision = '1f4684722e7a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('description', sa.Text(), server_default=sa.text("''::text"), nullable=False),
    sa.Column('openai_schema', sa.Text(), server_default=sa.text("''::text"), nullable=False),
